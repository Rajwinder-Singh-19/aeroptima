...
EXAMPLE:
    ...
    '''
    control_points is equal to np.array(
    [[0 1]
     [1 2]
     [2 3]
     [3 4]]
...
"""
def __curve_point(t: float, matrix: np.ndarray , control_points: np.ndarray) -> np.ndarray
...
EXAMPLE:
    ...
    '''
    curve_point_at_t_0.5 is equal to np.array([1.5, 2.5])
    '''
"""
...
EXAMPLE:
    ...
    '''
    cubic_curve_points_10_pts is equal to np.array(
    [[0.         1.        ]
...
if __name__ == "__main__":
    ...
    pts = cubic_bezier_curve(P0, P1, P2, P3, n_points=10)
    print(pts)
